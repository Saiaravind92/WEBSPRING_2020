...
export class SearchRecipeComponent implements OnInit {
  ...
  recepieAppid = '&app_id=3abf1d29';
  recepieKey = '&app_key=23706ab4598e9ad0931ee3e7421a7ddd';

  placesApi = 'https://api.foursquare.com/v2/venues/search?';
  clientdId = 'client_id=K0GWYM0FA55LIGWSXHSTPIVFS0DXTCCYHXE3TXJQSEWKE0ZO';
  clientSecret = '&client_secret=10XZTXWAW13Y5VB1GPOOZJMVXZXCTLOX5YBKVD5Z1H1RMHDI';
  version = '&v=20180323';
  near = '&near=';
  query = '&query=';
